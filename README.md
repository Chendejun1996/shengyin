...
<details open>
<summary><b>v1.1.1</b> (2026-04-29) — 音频播放引擎 + 持久化连接 ⭐</summary>

✨ **新功能**
- 🔊 **真正的音频播放**：接入 just_audio 引擎，点歌直接流式播放
- 💾 **服务器地址持久化**：关闭 APP 后自动记住，下次打开即连
- 🖼️ **专辑封面修复**：新增 `/api/cover/album/` 端点，专辑页封面正常显示

🔧 **优化**
- ✅ 首页去掉「扫描音乐库」按钮，改为只读刷新
- ✅ 修复 `AlbumDetailScreen` Provider 访问异常
- ✅ 代码推送至 GitHub 并打标签 v1.1.1
